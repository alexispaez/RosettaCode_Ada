...
procedure Not_Coded is
   ...
   begin
      loop
         Put_Line (Uri_Xml & Category & (To_String (Cmcontinue)));
         Page :=
         ...
         Put ("Length found: ");
         Put_Line( Integer'Image (Length (List)));
         ...
         Put_Line ("Getting continue value, first_child");
         N          := Item (List, 0);
         Put_Line ("Getting continue value, attribute");
